...
public final class Reply implements PropertyChangeListener {
    ...
    /**
     * Sets the {@link Reply}s of this {@link Reply}.<br><strong>Note: </strong>This method is intended to be used only use while deriving
     * {@link Reply}s from external storage!
     * @param replies
    ...
    /**
     * Removes all {@link Reply}s from this {@link Reply}. This method is intended to be used when closing reviews or using the cleanup function.
