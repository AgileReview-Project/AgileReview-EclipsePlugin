...
public class ExceptionHandler {
	...
	/**
	 * This method opens a message dialog in order to inform the user about the error occurred. Therefore the provided message
	 * will be shown.
	 * @param msg Message to be shown to the user
	 * @author Peter Reuter (28.03.2012)
	 */
	public static void notifyUser(final String msg) {
		Display.getDefault().asyncExec(new Runnable() {
			...
			@Override
			public void run() {
				MessageDialog.openError(Display.getCurrent().getActiveShell(), "An error occured", msg);
			}
		});
	}
}
