...
public class XmlBeansConversion {
    ...
    public static Review getReview(org.agilereview.xmlSchema.review.ReviewDocument.Review xmlBeansReview) {
        ...
        Review review = StorageAPI.createReview(id, name, status, reference, responsibility, description);
    ...
    public static Comment getComment(Review review, org.agilereview.xmlSchema.author.CommentDocument.Comment xmlBeansComment) {
        ...
        Comment comment = StorageAPI.createComment(id, authorName, commentedFile, review, creationDate, modificationDate, recipient, status,
                priority, text);
    ...
    /**
     * Converts an array of {@link org.agilereview.xmlSchema.author.ReplyDocument.Reply} objects to a {@link ArrayList} of {@link Reply} objects.
     ...
     * @return The {@link ArrayList} of {@link Reply} objects constructed from the array of
     *         {@link org.agilereview.xmlSchema.author.ReplyDocument.Reply} objects.
     * @author Peter Reuter (04.04.2012)
     */
