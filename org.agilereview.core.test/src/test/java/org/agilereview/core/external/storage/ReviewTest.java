...
public class ReviewTest {
    ...
    public final void testReviewString() {
        ...
        if (!"testID".equals(review.getId())) { throw new AssertionFailedError("Review not created consistently!"); }
    }
    
    /**
     * Test method for {@link org.agilereview.core.external.storage.Review#Review(String, String, int, String, String, String)}.
     * @author Malte Brunnlieb (19.02.2012)
     */
    @Test
    public final void testReviewStringIntStringStringString() {
        ...
        // check consistency
        Review review = new Review("testID", "Test Review", 2, uri.toString(), "Karl-Hänsél", "test description");
        
        assertNotNull(review);
        
        if (!"testID".equals(review.getId()) || "Test Review".equals(review.getName()) || review.getStatus() != 2
                || !uri.toString().equals(review.getReference()) || !"Karl-Hänsél".equals(review.getResponsibility())
                || !"test description".equals(review.getDescription())) { throw new AssertionFailedError("Review not created consistently!"); }
    }
    ...
    public final void testSetStatus() {
        ...
        if (review.getStatus() != 9 || !pcl.getPropertyChanged()) { throw new AssertionFailedError("Review status could not be set successfully!"); }
    }
    ...
    public final void testSetReference() {
        ...
        if (!uri.toString().equals(review.getReference()) || !pcl.getPropertyChanged()) { throw new AssertionFailedError(
                "Review reference could not be set successfully!"); }
    }
    ...
    public final void testSetResponsibility() {
        ...
        if (!"Käusî Méusli".equals(review.getResponsibility()) || !pcl.getPropertyChanged()) { throw new AssertionFailedError(
                "Review responsibility could not be set successfully! " + review.getResponsibility() + pcl.getPropertyChanged()); }
    }
    ...
    public final void testSetComments() {
        ...
        if (!(comments.size() == review.getComments().size()) || !(review.getComments().contains(c1) && review.getComments().contains(c2))) { throw new AssertionFailedError(
                "Review comments could not be set successfully!"); }
    ...
    public final void testAddComment() {
        ...
        if (!(review.getComments().contains(c1)) || !(prevSize + 1 == review.getComments().size())
                || !c1.equals(review.getComments().get(review.getComments().size() - 1)) || !pcl.getPropertyChanged()) { throw new AssertionFailedError(
                "Review comment could not be added successfully!"); }
        
        review.addComment(c1);
        if (review.getComments().size() > prevSize + 1) { throw new AssertionFailedError("Review comment added twice!"); }
    }
    ...
    public final void testDeleteCommentComment() {
        ...
        if (!(prevSize - 1 == review.getComments().size()) || review.getComments().contains(comments[index]) || !pcl.getPropertyChanged()) { throw new AssertionFailedError(
                "Review comment could not be removed by object successfully!"); }
    }
    ...
    public final void testDeleteCommentInt() {
        ...
        if (!(prevSize - 1 == review.getComments().size()) || review.getComments().contains(comments[index]) || !pcl.getPropertyChanged()) { throw new AssertionFailedError(
                "Review comment could not be removed by index successfully!"); }
    }
    ...
    public final void testClearComments() {
        ...
        if (!(0 == review.getComments().size()) || !pcl.getPropertyChanged()) { throw new AssertionFailedError(
                "Review comments could not be cleared successfully!"); }
    }
    ...
    public final void testSetIsOpen() {
        ...
        if (!(review.getIsOpen() == false) || !pcl.getPropertyChanged()) { throw new AssertionFailedError(
                "Review property isOpen could not be set successfully!"); }
